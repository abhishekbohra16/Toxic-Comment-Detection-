...
print("✅ Preprocessing complete and saved as 'preprocessed_train.csv'")
...
print("\n✅ TF-IDF features generated and saved successfully!")
...
for label in labels:  # labels = list of your output columns
    print(f"\n🚀 Training Balanced Logistic Regression for '{label}'...")

    lr = LogisticRegression(max_iter=200, n_jobs=-1, class_weight='balanced')
    lr.fit(X_train, y_train[label])
    y_pred = lr.predict(X_test)

    print(f"✅ Accuracy for {label}: {accuracy_score(y_test[label], y_pred):.4f}")
    print(classification_report(y_test[label], y_pred))

    balanced_lr_models[label] = lr

print("\n✅ All Logistic Regression models trained successfully with class balancing!")
...
print("🚀 Evaluating Balanced Logistic Regression Models...")
...
print("✅ Comment vectors created successfully!")
...
print("✅ Comment sequence vectors created successfully!")
...
print("✅ X_word2vec_sequences saved to 'X_word2vec_sequences.pkl'")
...
try:
    ...
    print("✅ X_word2vec_sequences loaded successfully!")
except FileNotFoundError:
    print("❌ Error: X_word2vec_sequences.pkl not found. Please ensure the cell to create and save sequence vectors is executed first.")
...
print("✅ Data split successfully with sequence vectors!")
